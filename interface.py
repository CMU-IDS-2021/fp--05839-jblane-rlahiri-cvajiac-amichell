...
interface.py defines the main interface page for our final project
"""
...
def write():
    ...
    * Your plots will appear below
    ...
    task = st.selectbox(
        "Which problem do you want to Visualize?",
        ["Word Count", "Spark for ML", "Apply Optimizations to an Extract, Transform, Load (ETL) job"])
